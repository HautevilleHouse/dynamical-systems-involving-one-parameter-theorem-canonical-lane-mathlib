...
import HautevilleHouse.DynamicalSystemsInvolvingOneParameterTheoremCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "DynamicalSystemsInvolvingOneParameterTheorem",
  theoremObject := "One-parameter topological consequences via admissible class",
